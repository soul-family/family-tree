...
- Active task list cleaned up to remove completed and duplicate entries
- Task workflow hooks expanded with standard session stages
- Deprecated task list cleaned up
...
- Broken cross-references in statistics documentation
- Normalization of cached session stats from older format
- Path replacement artifacts removed from documentation
- Stats generation no longer overwrites unrelated database stats when processing multiple databases
...
- Redundant per-developer placeholder documentation removed
